...
export default {
  ...
  icon: 'icondaibaifenbidehuanxingtu',
  // img: button_img,
  component: {
    template: `
      <van-circle v-model="options.modelValue" :rate="(options.interfaceDataConfig && options.interfaceDataConfig.value) || 0" :speed="100" :size="options.size">
        <slot name="default">
