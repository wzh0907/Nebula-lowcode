...
let optionsConfig = {
  ...
  beforeIcon: {
    // fontClass: 'iconfont iconxinxi',
    // unicode: 'e64f',
    fontClass: 'iconfont iconxinxi',
    unicode: 'e64f'
  },
  afterIcon: {
    // fontClass: 'iconfont iconxiangxia',
    // unicode: 'e632',
    fontClass: 'iconfont iconxiangxia',
    unicode: 'e632'
  },
    ...
    template: `
      <div
        ...
        :style="{
          ...
          'textAlign': options.styleEditorConfig.textHtmlPosit || (options.commonConfig && options.commonConfig.textAlign),
