        ...
        >
          ...
          >
            <el-form-item label="字段">
              <el-select v-model="item['databaseField']" placeholder="请选择" @change="changeTableFieldType(item)">
                <el-option
                  v-for="item in dataTableFieldList"
                  :key="item.name||item.columnName"
                  :label="item.name||item.columnName"
                  :value="item.name||item.columnName">
                </el-option>
              </el-select>
            </el-form-item>
            <el-form-item
