<template>
  <div class="variable-edit-div">
    <el-form label-width="60px" class="routeBy-form" label-position="left">
...
export default {
  ...
  watch: {
    ...
    variateInfo(newData, oldVal){
      if(newData){
        this.$emit("setVar", newData, this.type);
      }
    }
  },
  // computed: {
  ...
  // },
  methods: {
    ...mapMutations(["setVarTagList", "setVariableList"]),
    init() {
