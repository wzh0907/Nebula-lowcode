<template>
  ...
  <div class="group-wrap">
    <div class="group-content">
      <p style="margin-bottom: 30px;">该操作表示要在数据库连接上执行的特定操作。例如，在操作中，您定义是获取还是发送信息，如何批量提交数据库插入等</p>
      <i-form
        :model="connectorItem"
        :rules="opRule"
        ref="connectorForm"
      ...
      >
        ...
        <Form-item prop="connection_op" label="数据操作">
          <!--<i-select v-model="connectorItem.connection_op" filterable @on-change="onSelectChange">-->
    ...
    <div class="group-btns">
      <Row>
        ...
        <el-button class="btn" type="primary" size="small" @click="saveConfig('connectorForm')">保存</el-button>
