            ...
            <div class="menu_container">
              ...
              >
                <ul v-for="(menu, index) in menuList" :key="index">
                  <li
                    :class="{ chosen_li: menu.id == chosenId }"
                    class="menu_li"
                  ...
                  <ul v-for="(child, childIndex) in menu.children" :key="childIndex">
                    <li
                      :class="{ chosen_li: child.id == chosenId }"
                      class="menu_children"
                    ...
                    >
                      ...
                      <!-- <i
                        class="el-icon-circle-plus-outline plus_sub"
                        :class="{'chosen_plus':child.id==chosenId}"
                        @click="addSubMenu(child.id)"
                      ></i>-->
                    </li>
                    <ul v-for="(subChild, key) in child.children" :key="key">
                      <li
                        :class="{ chosen_li: subChild.id == chosenId }"
                        class="menu_sub_children"
                        @click="select(subChild.id)"
                      >
                        {{ subChild.name }}
                      </li>
                    </ul>
  ...
  methods: {
    ...
    initReportList() {
      ...
      getListAllV4(params).then((res) => {
        ...
        // console.log('item=')
        console.log(this.reportOptions[0])
      })
    },
    select(id) {
      this.chosenId = id
