<template>
  <el-dialog :title="title" width="600px" :close-on-click-modal="false" :visible.sync="isShowDialog" @open="dialogOpen">
    <el-form ref="dbForm" v-loading="listLoading" :rules="rules" :model="dataForm">
      ...
      <el-tabs v-model="activeName">
        <el-tab-pane label="测试环境" name="develop">
          <el-form-item label="主机地址：" :label-width="formLabelWidth" prop="dbHost" style="margin-top: 10px">
            <div style="display:flex">
              <el-input v-model="dataForm.dbHost" placeholder="请输入主机地址"/>: <el-input v-model="dataForm.dbPort" placeholder="请输入端口" />
            </div>
          </el-form-item>
        ...
        <el-tab-pane label="生产环境" name="release">
          <el-form-item label="主机地址：" :label-width="formLabelWidth" prop="dbHost" style="margin-top: 10px">
            <div style="display:flex">
              <el-input v-model="dataForm.dbHostProd" placeholder="请输入主机地址"/>: <el-input v-model="dataForm.dbPortProd" placeholder="请输入端口" />
            </div>
          </el-form-item>
          <!-- <el-form-item v-if="isActiveType=='database'" label="端口：" :label-width="formLabelWidth" prop="dbPort">
            <el-input v-model="dataForm.dbPort" />
          ...
          <el-form-item v-if="isActiveType=='database'" label="数据库名称：" :label-width="formLabelWidth" prop="dbName">
            <el-input v-model="dataForm.dbNameProd" />
          </el-form-item>
          <el-form-item v-if="isActiveType=='connect'" label="秘钥：" :label-width="formLabelWidth" prop="secret">
            <el-input v-model="dataForm.secret" />
          </el-form-item>
          <el-form-item v-if="isActiveType=='database'" label="用户名：" :label-width="formLabelWidth" prop="userName">
            <el-input v-model="dataForm.userNameProd" />
          </el-form-item>
          <el-form-item v-if="isActiveType=='database'" label="密码：" :label-width="formLabelWidth" prop="password">
            <el-input v-model="dataForm.passwordProd" type="password" />
          </el-form-item>
          <el-form-item v-if="isActiveType=='connect'" label="用户名：" :label-width="formLabelWidth">
            <el-input v-model="dataForm.userNameProd" />
          </el-form-item>
